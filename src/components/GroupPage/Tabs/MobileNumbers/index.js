...
import { fetchGetMobileNumbersForGroup } from "../../../../store/actions";
...
export class PhoneNumbersTab extends Component {
                  ...
                  <tbody>
                    {paginationPhoneNumbers[page].map((number, i) => (
                      <PhoneNumber
                        ...
                        onReload={() =>
                          this.props.fetchGetMobileNumbersForGroup(
                            this.props.tenantId,
                            this.props.groupId
                          )
                        }
  ...
  handleSingleCheckboxClick = index => {
    const newArr = this.state.phoneNumbers.map((el, i) => ({
      ...el,
      phoneChecked: index === i && !el.phoneChecked
    }));
